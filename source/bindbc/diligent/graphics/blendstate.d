...
struct RenderTargetBlendDesc
{
    ...
    BLEND_OPERATION BlendOp = BLEND_OPERATION.BLEND_OPERATION_ADD;
    ...
    /// Default value: Diligent::BLEND_FACTOR_ONE.
    BLEND_FACTOR SrcBlendAlpha = BLEND_FACTOR.BLEND_FACTOR_ONE;

    /// Specifies the blend factor to apply to the alpha value in the render target.
    /// Blend factors that end in _COLOR are not allowed. 
    /// Default value: Diligent::BLEND_FACTOR_ZERO.
    BLEND_FACTOR DestBlendAlpha = BLEND_FACTOR.BLEND_FACTOR_ZERO;
    ...
    /// Default value: Diligent::BLEND_OPERATION_ADD.
    BLEND_OPERATION BlendOpAlpha = BLEND_OPERATION.BLEND_OPERATION_ADD;

    /// Defines logical operation for the render target.
    /// Default value: Diligent::LOGIC_OP_NOOP.
	LOGIC_OPERATION LogicOp = LOGIC_OPERATION.LOGIC_OP_NOOP;

    /// Render target write mask.
    /// Default value: Diligent::COLOR_MASK_ALL.
    ubyte RenderTargetWriteMask = COLOR_MASK.COLOR_MASK_ALL;
}
...
struct BlendStateDesc
{
    ...
    RenderTargetBlendDesc[DILIGENT_MAX_RENDER_TARGETS] RenderTargets;
}
